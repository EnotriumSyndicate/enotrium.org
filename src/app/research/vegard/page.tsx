    ...
    <main className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 px-6 lg:px-16 max-w-[1400px] mx-auto py-16">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-2 border-white/30 pl-6 relative">
              <div className="text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">Layer 1</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Command</h3>
              <p className="text-sm text-gray-900/60 mb-4">Fused operational picture and tasking</p>
            ...
            {/* Layer 2 */}
            <div className="border-l-2 border-white/30 pl-6 relative">
              <div className="text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">Layer 2</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Fabric</h3>
              <p className="text-sm text-gray-900/60 mb-4">State mesh and coordination services</p>
              <div className="flex flex-wrap gap-2">
            ...
            {/* Layer 3 */}
            <div className="border-l-2 border-white/30 pl-6 relative">
              <div className="text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">Layer 3</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Node</h3>
              <p className="text-sm text-gray-900/60 mb-4">Arthedain + Icarus Model onboard</p>
              <div className="flex flex-wrap gap-2">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2 mb-6">
            <li>POSTs structured SoilPrediction payloads to AIP's <code className="text-gray-500">/api/vegard/ingest</code> endpoint</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2 mb-6">
            <li><strong>Entity model:</strong> <code className="text-gray-500">entity_id, type, position, soil_prediction, drift_flag, battery, timestamp</code></li>
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2 mb-6">
            <li>Each drone node has a deterministic identity: <code className="text-gray-500">drone:region:serial</code></li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2 mb-6">
            ...
            <li>Publish entity to state mesh: <code className="text-gray-500">drone_id, position, soil_prediction, drift_flag, health</code></li>
...
AIP                        (POST /api/vegard/ingest)`}
        ...
        <section className="mb-12">
          ...
          <p>
            <a href="https://github.com/EnotriumSyndicate/Vegard" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">
