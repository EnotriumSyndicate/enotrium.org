    ...
    <main className="min-h-screen bg-white">
      <div className="px-6 lg:px-16 max-w-[1400px] mx-auto py-16">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-3 mb-4">
        ...
        <section className="mb-12">
          ...
          <p>
            <a href="https://github.com/EnotriumSyndicate/AIP" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">
