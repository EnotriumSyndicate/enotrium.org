    ...
    <main className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 px-6 lg:px-16 max-w-[1400px] mx-auto py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            See <code className="text-gray-500">field_results/</code> for actual drone flight results with ground truth validation (79 samples, MD + DE pilots). Includes real vs predicted scatter plots for N, SOC, moisture, and confusion matrices.
          </p>
        </section>
...
└──────────────────────────────┘`}
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-2 text-center font-mono">
        ...
        <section className="mb-12">
          ...
          <h4 className="text-xl font-light text-gray-900 mb-3 font-[family-name:var(--font-inter)]">
            Polyethylene (PE)
          </h4>
          <div className="bg-gray-100 p-6 rounded-lg mb-4 text-center font-mono">
          ...
          <div className="bg-gray-100 p-6 rounded-lg text-center font-mono">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2">
            <li><a href="https://github.com/EnotriumSyndicate/Hyperspectral-Restruct" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">GitHub Repository</a></li>
            <li><a href="https://github.com/EnotriumSyndicate/Hyperspectral-Restruct/blob/main/Results.md" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">Results</a></li>
            <li><a href="https://oar.icrisat.org/13212/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">ICRISAT Open Access Repository</a></li>
            <li><a href="https://www.sciencedirect.com/science/article/pii/S2949919425000305" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">ScienceDirect Article</a></li>
            <li><a href="https://zenodo.org/records/8143355" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 underline">Munsell Soil Color Dataset (Zenodo)</a></li>
          </ul>
        </section>
      </div>
    </main>
