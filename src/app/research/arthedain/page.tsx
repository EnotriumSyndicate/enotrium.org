    ...
    <main className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 px-6 lg:px-16 max-w-[1400px] mx-auto py-16">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-6 font-mono text-sm leading-8">
            <div className="mb-2">
              e_fast(t) = γ_fast · e_fast(t−1) + pre × post
              <span className="text-gray-900/40 ml-4 italic">— ~100ms window, immediate correlations</span>
            </div>
            <div className="mb-2">
              e_slow(t) = γ_slow · e_slow(t−1) + pre × post
              <span className="text-gray-900/40 ml-4 italic">— ~700ms window, longer dependencies</span>
            </div>
            <div className="mb-2">
              E(t) = α · e_fast + β · e_slow
              <span className="text-gray-900/40 ml-4 italic">— combined eligibility trace</span>
            </div>
            <div>
              ΔW = η · E(t) · δ(t)
              <span className="text-gray-900/40 ml-4 italic">— local weight update modulated by error</span>
            </div>
          </div>
          <p className="text-lg text-gray-900/70 leading-relaxed mb-6">
            No weight transport. No forward passes stored in memory. Every synapse updates from local information only.
          </p>

          <h3 className="text-2xl font-light text-gray-900 mb-4 font-[family-name:var(--font-inter)]">
            Neuroscience Grounding
          </h3>
          <p className="text-lg text-gray-900/70 leading-relaxed mb-4">
            The dual-timescale design has direct biological analogs:
          </p>
          <ul className="list-disc list-inside text-lg text-gray-900/70 leading-relaxed space-y-2">
          ...
          <p className="text-lg text-gray-900/70 leading-relaxed mt-4">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-900/70 leading-relaxed mb-6">
            Built on the theoretical framework of <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC7367848/" target="_blank" rel="noopener noreferrer" className="text-gray-900/50 hover:text-gray-900 underline">e-prop</a> (Bellec et al., 2020), Arthedain implements a mathematically grounded approximation to gradient descent that eliminates backpropagation-through-time.
          </p>
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-4 text-center font-mono">
            ∂E/∂W_ji = Σ_t L_j^t · e_ji^t
          </div>
          <p className="text-lg text-gray-900/70 leading-relaxed mb-4">Where:</p>
          <ul className="list-disc list-inside text-lg text-gray-900/70 leading-relaxed space-y-2">
          ...
          <h3 className="text-2xl font-light text-gray-900 mb-4 mt-8 font-[family-name:var(--font-inter)]">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-6 text-center font-mono">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-900/70 leading-relaxed space-y-2 mb-6">
          ...
          <div className="bg-gray-100 p-6 rounded-lg font-mono text-sm overflow-x-auto">
            <pre className="text-gray-900/70">
...
for t in range(len(pattern)):
    y_pred, error = trainer.train_step(
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-gray-900/70 leading-relaxed space-y-2 mb-4">
...
for events, demand in supply_chain_stream(T=2000, drift_rate=0.001):
    ...`}</code>
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal list-inside text-lg text-gray-900/70 leading-relaxed space-y-2 mb-6">
    ...
    if t % 1000 == 0:
        print(f"Step {t}: error = {error.item():.4f}")`}</code>
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-4 font-mono text-sm">
            <code className="text-gray-900/70">python experiments/indy_benchmark.py --T_train 10000 --T_test 2000</code>
          </div>
          <p className="text-lg text-gray-900/70 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p>
            <a href="https://github.com/Aidistides/arthedain" target="_blank" rel="noopener noreferrer" className="text-gray-900/50 hover:text-gray-900 underline">
